<?php
// DIR
define('DIR_APPLICATION', '/home/redwoodtechlinux/public_html/novusprintflow.com/catalog/');
define('DIR_SYSTEM', '/home/redwoodtechlinux/public_html/novusprintflow.com/system/');
define('DIR_LANGUAGE', '/home/redwoodtechlinux/public_html/novusprintflow.com/catalog/language/');
define('DIR_TEMPLATE', '/home/redwoodtechlinux/public_html/novusprintflow.com/catalog/view/theme/');
...
if ($serverName=='novusprintflow.com') {
	...
	// HTTP, HTTPS
	define('HTTP_SERVER', 'http://www.novusprintflow.com/');
	define('HTTPS_SERVER', 'http://www.novusprintflow.com/');
	// DB
    ...
    // HTTP, HTTPS
    define('HTTP_SERVER', 'http://fakestore.novusprintflow.com/');
    define('HTTPS_SERVER', 'http://fakestore.novusprintflow.com/');
    // DB
    define('DB_USERNAME', 'dgannon');
    define('DB_PASSWORD', '@Boston1991');	
