...
!function(a){
	...
	c.initEditor=function(){
		...
		c.designer=new W2P.designer({
			...
			parentDiv:d.isInline?"#pp_inline_div":void 0,
			mode:d.mode,
			lang:d.lang,
			userId:d.userId,
			product:d.product,
